<div class="clearfix">
    <el-button type="" class="l" @click="open_dialog">新增演员</el-button>
    <!--搜索-->
    <form class="filter r" style="margin-bottom:10px">
        <el-input name="key" v-model="key" placeholder="请输入内容" class="input-with-select">
            ...
            <el-select v-model="type" slot="prepend" placeholder="请选择" name="types">
...
<div class="block">
    <el-pagination layout="prev, pager, next" :total="total" :current-page="page"
                   @current-change="gopage"></el-pagination>
</div>
...
<el-dialog title="操作" :visible="dialog" @close="dialog = false">
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="年龄" prop="age" prop="age">
            <el-input v-model="form.age"></el-input>
        </el-form-item>
        <el-form-item label="性别" prop="sex" prop="sex">
...
<script src="static/js/actor.js"></script>
